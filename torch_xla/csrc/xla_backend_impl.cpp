...
class XlaBackendImpl : public torch::lazy::BackendImplInterface {
 public:
  ...
  at::Tensor MakeTensorFromComputationData(
    ...
    // TODO: handle the logical_scalar_type == nullptr case
  ...
  std::unique_ptr<torch::lazy::LoweringContext> CreateLoweringContext(
    ...
    // TODO: change LoweringContext to take post_order as
  ...
  std::vector<torch::lazy::ComputationPtr> Compile(
    ...
    for (const torch::lazy::ComputationPtr instance : instances) {
      // TODO: device is missing in instance, use CurrentDevice for now
      ...
      // TODO: Verify this with GPU, we might only have 1 process with multiple
      // GPU as replica.
    ...
    // TODO: wrap the `xla::ComputationClient::Computation` inside
